...
class JasperPHP
{
    ...
    public function processXML($input_file, $output_file = false,  $format = array("pdf"),$data_file,$xml_xpath = "/Course/Students/Student", $background = true, $redirect_output = true)
    {
        if(is_null($input_file) || empty($input_file))
            throw new \Exception("No input file", 1);
