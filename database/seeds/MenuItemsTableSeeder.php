    ...
    public function run()
    {
        ...
        \DB::table('menu_items')->insert(
            array(
                ...
                array('id' => '31', 'menu_id' => '1', 'title' => 'أماكن الدورات', 'url' => '/admin/venues', 'target' => '_self', 'icon_class' => 'voyager-thumb-tack', 'color' => '#000000', 'parent_id' => NULL, 'order' => '15', 'created_at' => '2016-12-14 15:51:08', 'updated_at' => '2016-12-27 12:04:09'),
                ...
                array('id' => '39', 'menu_id' => '1', 'title' => 'المدرسين', 'url' => '/admin/teachers', 'target' => '_self', 'icon_class' => 'voyager-pen', 'color' => '#000000', 'parent_id' => NULL, 'order' => '10', 'created_at' => '2016-12-26 09:30:19', 'updated_at' => '2016-12-27 12:04:09')
            )
        );
