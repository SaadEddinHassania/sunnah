        ...
        <div class="widgets">
            ...
            <div class="panel widget center bgimage"
                ...
                <div class="panel-content">
                    ...
                    <h4>كافة المشرفين</h4>
                    <form role="form"
                          action="{{ route('admin.supervisors.reports') }}"
            ...
            <div class="panel widget center bgimage"
                ...
                <div class="panel-content">
                    ...
                    <h4>مشرفين حسب المؤهل العلمي</h4>
                    <form role="form"
                          action="{{ route('admin.supervisors.reports') }}"
                          method="POST" enctype="multipart/form-data">
        ...
        <div class="widgets">
            ...
            <div class="panel widget center bgimage"
                ...
                <div class="panel-content">
                    ...
                    <h4>مشرفين حسب الدور</h4>
                    <form role="form"
                          action="{{ route('admin.supervisors.reports') }}"
                          method="POST" enctype="multipart/form-data">

                        <input type="hidden" name="col" value="role_id"/>
                        <div class="col-sm-12 col-centered">
                            <?php $types = \App\Models\Role::toDropDown()?>
                            <select name="value" class='form-control'>
                                @foreach($types as $key => $value)
                                    <option value="{{$key}}">{{$value}}</option>
                                @endforeach
