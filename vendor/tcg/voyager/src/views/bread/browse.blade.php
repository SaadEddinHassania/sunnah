...
@section('page_header')
    <h1 class="page-title">
        ...
        <a href="{{ route($dataType->slug.'.create') }}" class="btn btn-success"><i class="voyager-plus"></i> Add New</a>
    </h1>
@stop
                        ...
                        <table id="dataTable" class="table table-hover">
                            ...
                            <tr>
                                @foreach($dataType->browseRows as $rows)
                                    <th style="text-align: right">{{ $rows->display_name }}</th>
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        <a href="{{ route($dataType->slug.'.edit', $data->id) }}"
                                           class="btn-sm btn-primary pull-left edit"><i class="voyager-edit"></i> Edit</a>
                                        <a href="{{ route($dataType->slug.'.show', $data->id) }}"
                                           class="btn-sm btn-warning pull-left" style="margin-left: 5px"><i class="voyager-eye"></i> View</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        Are you sure you want to delete this {{ $dataType->display_name_singular }}?
                ...
                <div class="modal-footer">
                    <form action="{{ route($dataType->slug.'.index') }}" id="delete_form" method="POST">
                        ...
                        <input type="submit" class="btn btn-danger pull-left delete-confirm"
